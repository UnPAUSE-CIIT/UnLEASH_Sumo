...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 2
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-944.0,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -944, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -491.5
    m_HBaseRangeMax: 491.5
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1219, y: 574}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      index: 3
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":98.0,"y":25.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 98, y: 25}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 0
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":2,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":0.0,"y":25.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 0, y: 25}
      snapOffsetDelta: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 1
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":0.0,"y":25.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":0,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 0, y: 25}
      snapOffsetDelta: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":30.0,"y":0.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 30, y: 0}
      snapOffsetDelta: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":true,"m_FloatingSnapOffset":{"x":-207.0009765625,"y":-247.0009765625},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 1
      collapsed: 0
      snapOffset: {x: -207.00098, y: -247.00098}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    m_Target: {x: -1.6714725, y: 1.6613178, z: -4.9709215}
    speed: 2
    m_Value: {x: -1.6714725, y: 1.6613177, z: -4.9709215}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: 0.19659828, y: 0.16240528, z: -0.033039264, w: 0.9663788}
    speed: 2
    m_Value: {x: 0.20297179, y: 0.14480507, z: -0.030364627, w: 0.9679422}
  m_Size:
    m_Target: 0.8660254
    speed: 2
    m_Value: 0.8660254
  ...
  m_LastSceneViewRotation: {x: 0.08937303, y: 0.19149573, z: -0.017512871, w: 0.97725904}
...
MonoBehaviour:
  ...
  m_LastProjectPath: D:\UnLEASH_Sumo
  m_LockTracker:
    m_IsLocked: 1
...
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {fileID: 11500000, guid: c6d6781ee7c9d0f45974096882ac5a45, type: 3}
  m_Name: 
  m_EditorClassIdentifier: Assembly-CSharp-Editor::LDTool
  m_MinSize: {x: 50, y: 50}
  m_MaxSize: {x: 4000, y: 4000}
  m_TitleContent:
    m_Text: Helper
